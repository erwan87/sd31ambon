...
<body style="background-image:url(./frontend/assets/images/sekolah/backsekolah.jpg);background-repeat: no-repeat;background-attachment: fixed;background-size: 100% 100%;">
	<div class="container">